...
console.log(
  "We can invite only two people for dinner because we have only two guest spaces"
);
...
while (guest_names.length > 2) {
  ...
  console.log(
    `hello, ${removed_guest}, Sorry! You are not invited to come on dinner.\nThank You\n`
  );
}
...
for (let i = 0; i < guest_names.length; i++) {
  ...
  console.log(
    `hello, ${guest}, You are invited to come on dinner.\nThank You\n`
  );
}
